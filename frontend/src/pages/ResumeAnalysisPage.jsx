              ...
              return (
                <button
                  ...
                  className={`p-3.5 rounded-2xl text-left border transition relative flex flex-col justify-between ${
                    isSelected
                      ? "bg-gradient-to-br from-indigo-500/20 via-purple-500/10 to-transparent border-indigo-400/60 shadow-glow"
      ...
      <AnimatePresence>
        {analyzing && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="p-6 rounded-3xl bg-gradient-to-r from-indigo-900/30 via-purple-900/20 to-slate-900/40 border border-indigo-500/30 backdrop-blur-xl shadow-glow"
          >
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-medium transition whitespace-nowrap ${
                    isActive
